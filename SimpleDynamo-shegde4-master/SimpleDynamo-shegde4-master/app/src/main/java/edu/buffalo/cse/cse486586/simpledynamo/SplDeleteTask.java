...
/**
 * Created by srivatsa on 5/9/18.
 */

public class SplDeleteTask extends AsyncTask<String, Void, Void> {
    @Override
    protected Void doInBackground(String... strings) {
        //String remotePort = strings[1];
        String[] ports = {strings[1],strings[2]};
        ...
        for(int i =0;i<ports.length;i++) {
            try {
                ...
                Log.v("MYTAG", "wrote the msg for deletion to remote(replicas):" + msg);
